...
static void  gimp_helper_options_finalize           (GObject         *object);
static void  gimp_helper_options_set_property       (GObject         *object,
                                                   guint            property_id,
                                                   const GValue    *value,
                                                   GParamSpec      *pspec);
static void  gimp_helper_options_get_property       (GObject         *object,
                                                   guint            property_id,
                                                   GValue          *value,
                                                   GParamSpec      *pspec);

static void  gimp_helper_options_reset              (GimpToolOptions *tool_options);

static void  gimp_helper_options_notify_font        (GimpContext     *context,
                                                   GParamSpec      *pspec,
                                                   GimpText        *text);
static void  gimp_helper_options_notify_text_font   (GimpText        *text,
                                                   GParamSpec      *pspec,
                                                   GimpContext     *context);
static void  gimp_helper_options_notify_color       (GimpContext     *context,
                                                   GParamSpec      *pspec,
                                                   GimpText        *text);
static void  gimp_helper_options_notify_text_color  (GimpText        *text,
                                                   GParamSpec      *pspec,
                                                   GimpContext     *context);


G_DEFINE_TYPE_WITH_CODE (GimpHelperOptions, gimp_helper_options,
                         GIMP_TYPE_TOOL_OPTIONS,
                         G_IMPLEMENT_INTERFACE (GIMP_TYPE_RECTANGLE_OPTIONS,
                                                NULL))

#define parent_class gimp_helper_options_parent_class


static void
gimp_helper_options_class_init (GimpHelperOptionsClass *klass)
{
  GObjectClass         *object_class  = G_OBJECT_CLASS (klass);
  GimpToolOptionsClass *options_class = GIMP_TOOL_OPTIONS_CLASS (klass);

  object_class->finalize     = gimp_helper_options_finalize;
  object_class->set_property = gimp_helper_options_set_property;
  object_class->get_property = gimp_helper_options_get_property;

  options_class->reset       = gimp_helper_options_reset;
...
static void
gimp_helper_options_init (GimpHelperOptions *options)
{
  options->size_entry = NULL;
}

static void
gimp_helper_options_finalize (GObject *object)
{
  GimpHelperOptions *options = GIMP_HELPER_OPTIONS (object);
...
static void
gimp_helper_options_get_property (GObject    *object,
                                guint       property_id,
                                GValue     *value,
                                GParamSpec *pspec)
{
...
static void
gimp_helper_options_set_property (GObject      *object,
                                guint         property_id,
                                const GValue *value,
                                GParamSpec   *pspec)
{
...
static void
gimp_helper_options_reset (GimpToolOptions *tool_options)
{
...
static void
gimp_helper_options_notify_font (GimpContext *context,
                               GParamSpec  *pspec,
                               GimpText    *text)
{
  g_signal_handlers_block_by_func (text,
                                   gimp_helper_options_notify_text_font,
                                   context);
...
static void
gimp_helper_options_notify_text_font (GimpText    *text,
                                    GParamSpec  *pspec,
                                    GimpContext *context)
{
  g_signal_handlers_block_by_func (context,
                                   gimp_helper_options_notify_font, text);
...
static void
gimp_helper_options_notify_color (GimpContext *context,
                                GParamSpec  *pspec,
                                GimpText    *text)
{
  GimpRGB  color;
  ...
  g_signal_handlers_block_by_func (text,
                                   gimp_helper_options_notify_text_color,
                                   context);
...
static void
gimp_helper_options_notify_text_color (GimpText    *text,
                                     GParamSpec  *pspec,
                                     GimpContext *context)
{
  g_signal_handlers_block_by_func (context,
                                   gimp_helper_options_notify_color, text);
...
/*  This function could live in gimphelpertool.c also.
 *  But it takes some bloat out of that file...
 */
void
gimp_helper_options_connect_text (GimpHelperOptions *options,
                                GimpText        *text)
{
  GimpContext *context;
  GimpRGB      color;

  g_return_if_fail (GIMP_IS_HELPER_OPTIONS (options));
  ...
  g_signal_connect_object (options, "notify::font",
                           G_CALLBACK (gimp_helper_options_notify_font),
                           text, 0);
  g_signal_connect_object (text, "notify::font",
                           G_CALLBACK (gimp_helper_options_notify_text_font),
                           options, 0);

  g_signal_connect_object (options, "notify::foreground",
                           G_CALLBACK (gimp_helper_options_notify_color),
                           text, 0);
  g_signal_connect_object (text, "notify::color",
                           G_CALLBACK (gimp_helper_options_notify_text_color),
                           options, 0);
}

GtkWidget *
gimp_helper_options_gui (GimpToolOptions *tool_options)
{
  GObject         *config    = G_OBJECT (tool_options);
  GimpHelperOptions *options   = GIMP_HELPER_OPTIONS (tool_options);
...
static void
gimp_helper_options_editor_dir_changed (GimpTextEditor  *editor,
                                      GimpHelperOptions *options)
{
...
static void
gimp_helper_options_editor_notify_dir (GimpHelperOptions *options,
                                     GParamSpec      *pspec,
...
static void
gimp_helper_options_editor_notify_font (GimpHelperOptions *options,
                                      GParamSpec      *pspec,
                                      GimpTextEditor  *editor)
{
...
GtkWidget *
gimp_helper_options_editor_new (GtkWindow       *parent,
                              Gimp            *gimp,
                              GimpHelperOptions *options,
                              ...
                              gdouble          yres)
{
  ...
  g_return_val_if_fail (GIMP_IS_HELPER_OPTIONS (options), NULL);
  ...
  g_signal_connect_object (editor, "dir-changed",
                           G_CALLBACK (gimp_helper_options_editor_dir_changed),
                           options, 0);
  g_signal_connect_object (options, "notify::base-direction",
                           G_CALLBACK (gimp_helper_options_editor_notify_dir),
                           editor, 0);
  g_signal_connect_object (options, "notify::font",
                           G_CALLBACK (gimp_helper_options_editor_notify_font),
                           editor, 0);
