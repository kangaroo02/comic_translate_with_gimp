...
static void   gimp_helper_tool_ensure_proxy       (GimpHelperTool    *text_tool);
static void   gimp_helper_tool_move_cursor        (GimpHelperTool    *text_tool,
                                                 GtkMovementStep  step,
                                                 gint             count,
                                                 gboolean         extend_selection);
static void   gimp_helper_tool_insert_at_cursor   (GimpHelperTool    *text_tool,
                                                 const gchar     *str);
static void   gimp_helper_tool_delete_from_cursor (GimpHelperTool    *text_tool,
                                                 GtkDeleteType    type,
                                                 gint             count);
static void   gimp_helper_tool_backspace          (GimpHelperTool    *text_tool);
static void   gimp_helper_tool_toggle_overwrite   (GimpHelperTool    *text_tool);
static void   gimp_helper_tool_select_all         (GimpHelperTool    *text_tool,
                                                 gboolean         select);
static void   gimp_helper_tool_change_size        (GimpHelperTool    *text_tool,
                                                 gdouble          amount);
static void   gimp_helper_tool_change_baseline    (GimpHelperTool    *text_tool,
                                                 gdouble          amount);
static void   gimp_helper_tool_change_kerning     (GimpHelperTool    *text_tool,
                                                 gdouble          amount);

static void   gimp_helper_tool_options_notify     (GimpHelperOptions *options,
                                                 GParamSpec      *pspec,
                                                 GimpHelperTool    *text_tool);
static void   gimp_helper_tool_editor_dialog      (GimpHelperTool    *text_tool);
static void   gimp_helper_tool_editor_destroy     (GtkWidget       *dialog,
                                                 GimpHelperTool    *text_tool);
static void   gimp_helper_tool_enter_text         (GimpHelperTool    *text_tool,
                                                 const gchar     *str);
static void   gimp_helper_tool_xy_to_iter         (GimpHelperTool    *text_tool,
                                                 gdouble          x,
                                                 gdouble          y,
                                                 GtkTextIter     *iter);
static void   gimp_helper_tool_im_commit          (GtkIMContext    *context,
                                                 const gchar     *str,
                                                 GimpHelperTool    *text_tool);
static void   gimp_helper_tool_im_preedit_start   (GtkIMContext    *context,
                                                 GimpHelperTool    *text_tool);
static void   gimp_helper_tool_im_preedit_end     (GtkIMContext    *context,
                                                 GimpHelperTool    *text_tool);
static void   gimp_helper_tool_im_preedit_changed (GtkIMContext    *context,
                                                 GimpHelperTool    *text_tool);
...
void
gimp_helper_tool_editor_init (GimpHelperTool *text_tool)
{
  ...
  g_signal_connect (text_tool->im_context, "commit",
                    G_CALLBACK (gimp_helper_tool_im_commit),
                    text_tool);
  g_signal_connect (text_tool->im_context, "preedit-start",
                    G_CALLBACK (gimp_helper_tool_im_preedit_start),
                    text_tool);
  g_signal_connect (text_tool->im_context, "preedit-end",
                    G_CALLBACK (gimp_helper_tool_im_preedit_end),
                    text_tool);
  g_signal_connect (text_tool->im_context, "preedit-changed",
                    G_CALLBACK (gimp_helper_tool_im_preedit_changed),
                    text_tool);

}

void
gimp_helper_tool_editor_finalize (GimpHelperTool *text_tool)
{
...
void
gimp_helper_tool_editor_start (GimpHelperTool *text_tool)
{
  ...
  if (options->use_editor)
    gimp_helper_tool_editor_dialog (text_tool);

  g_signal_connect (options, "notify::use-editor",
                    G_CALLBACK (gimp_helper_tool_options_notify),
                    text_tool);
...
void
gimp_helper_tool_editor_position (GimpHelperTool *text_tool)
{
  if (text_tool->style_overlay)
    {
      GimpTool         *tool    = GIMP_TOOL (text_tool);
...
void
gimp_helper_tool_editor_halt (GimpHelperTool *text_tool)
{
  GimpHelperOptions *options = GIMP_HELPER_TOOL_GET_OPTIONS (text_tool);
...
void
gimp_helper_tool_editor_button_press (GimpHelperTool        *text_tool,
                                    gdouble              x,
                                    gdouble              y,
                                    GimpButtonPressType  press_type)
{
  ...
  gimp_helper_tool_xy_to_iter (text_tool, x, y, &cursor);
...
void
gimp_helper_tool_editor_button_release (GimpHelperTool *text_tool)
{
  GtkTextBuffer *buffer = GTK_TEXT_BUFFER (text_tool->buffer);
...
void
gimp_helper_tool_editor_motion (GimpHelperTool *text_tool,
                              gdouble       x,
                              gdouble       y)
{
  GtkTextBuffer *buffer = GTK_TEXT_BUFFER (text_tool->buffer);
...
gboolean
gimp_helper_tool_editor_key_press (GimpHelperTool *text_tool,
                                 GdkEventKey  *kevent)
{
  GimpTool         *tool   = GIMP_TOOL (text_tool);
  GimpDisplayShell *shell  = gimp_display_get_shell (tool->display);
  ...
  gimp_helper_tool_ensure_proxy (text_tool);
  ...
  switch (kevent->keyval)
    ...
    case GDK_KEY_ISO_Enter:
      gimp_helper_tool_reset_im_context (text_tool);
      gimp_helper_tool_enter_text (text_tool, "\n");
      break;
...
gboolean
gimp_helper_tool_editor_key_release (GimpHelperTool *text_tool,
                                   GdkEventKey  *kevent)
{
  if (gtk_im_context_filter_keypress (text_tool->im_context, kevent))
    {
...
void
gimp_helper_tool_reset_im_context (GimpHelperTool *text_tool)
{
...
void
gimp_helper_tool_editor_get_cursor_rect (GimpHelperTool   *text_tool,
                                       gboolean        overwrite,
...
void
gimp_helper_tool_editor_update_im_rect (GimpHelperTool *text_tool)
{
...
static void
gimp_helper_tool_ensure_proxy (GimpHelperTool *text_tool)
{
  GimpTool         *tool  = GIMP_TOOL (text_tool);
  GimpDisplayShell *shell = gimp_display_get_shell (tool->display);
      ...
      if (! cancel_selection)
        {
          ...
          if (! gimp_helper_tool_ensure_layout (text_tool))
            break;
...
static void
gimp_helper_tool_insert_at_cursor (GimpHelperTool *text_tool,
                                 const gchar  *str)
{
...
static void
gimp_helper_tool_delete_from_cursor (GimpHelperTool  *text_tool,
                                   GtkDeleteType  type,
                                   gint           count)
{
  GtkTextBuffer *buffer = GTK_TEXT_BUFFER (text_tool->buffer);
...
static void
gimp_helper_tool_backspace (GimpHelperTool *text_tool)
{
  GtkTextBuffer *buffer = GTK_TEXT_BUFFER (text_tool->buffer);
...
static void
gimp_helper_tool_toggle_overwrite (GimpHelperTool *text_tool)
{
  gimp_draw_tool_pause (GIMP_DRAW_TOOL (text_tool));
...
static void
gimp_helper_tool_select_all (GimpHelperTool *text_tool,
                           gboolean      select)
{
  GtkTextBuffer *buffer = GTK_TEXT_BUFFER (text_tool->buffer);
...
static void
gimp_helper_tool_change_size (GimpHelperTool *text_tool,
                            gdouble       amount)
{
  GtkTextBuffer *buffer = GTK_TEXT_BUFFER (text_tool->buffer);
  GtkTextIter    start;
...
static void
gimp_helper_tool_change_baseline (GimpHelperTool *text_tool,
                                gdouble       amount)
{
  GtkTextBuffer *buffer = GTK_TEXT_BUFFER (text_tool->buffer);
  GtkTextIter    start;
...
static void
gimp_helper_tool_change_kerning (GimpHelperTool *text_tool,
                               gdouble       amount)
{
  GtkTextBuffer *buffer = GTK_TEXT_BUFFER (text_tool->buffer);
  GtkTextIter    start;
...
static void
gimp_helper_tool_options_notify (GimpHelperOptions *options,
                               GParamSpec      *pspec,
                               GimpHelperTool    *text_tool)
{
...
static void
gimp_helper_tool_editor_dialog (GimpHelperTool *text_tool)
{
  GimpTool          *tool    = GIMP_TOOL (text_tool);
  GimpHelperOptions   *options = GIMP_HELPER_TOOL_GET_OPTIONS (text_tool);
  ...
  text_tool->editor_dialog =
    gimp_helper_options_editor_new (parent, tool->tool_info->gimp, options,
  ...
  g_signal_connect (text_tool->editor_dialog, "destroy",
                    G_CALLBACK (gimp_helper_tool_editor_destroy),
                    text_tool);
...
static void
gimp_helper_tool_editor_destroy (GtkWidget    *dialog,
                               GimpHelperTool *text_tool)
{
  GimpHelperOptions *options = GIMP_HELPER_TOOL_GET_OPTIONS (text_tool);
...
static void
gimp_helper_tool_enter_text (GimpHelperTool *text_tool,
                           const gchar  *str)
{
  GtkTextBuffer *buffer = GTK_TEXT_BUFFER (text_tool->buffer);
  ...
  gimp_helper_tool_delete_selection (text_tool);
  ...
  if (! had_selection && text_tool->overwrite_mode && strcmp (str, "\n"))
    {
      ...
      if (! gtk_text_iter_ends_line (&cursor))
        gimp_helper_tool_delete_from_cursor (text_tool, GTK_DELETE_CHARS, 1);
    }
...
static void
gimp_helper_tool_xy_to_iter (GimpHelperTool *text_tool,
                           gdouble       x,
                           gdouble       y,
                           GtkTextIter  *iter)
{
...
static void
gimp_helper_tool_im_commit (GtkIMContext *context,
                          const gchar  *str,
                          GimpHelperTool *text_tool)
{
  gimp_helper_tool_enter_text (text_tool, str);
}

static void
gimp_helper_tool_im_preedit_start (GtkIMContext *context,
                                 GimpHelperTool *text_tool)
{
  GimpTool         *tool  = GIMP_TOOL (text_tool);
  GimpDisplayShell *shell = gimp_display_get_shell (tool->display);
...
static void
gimp_helper_tool_im_preedit_end (GtkIMContext *context,
                               GimpHelperTool *text_tool)
{
  if (text_tool->preedit_overlay)
    {
...
static void
gimp_helper_tool_im_preedit_changed (GtkIMContext *context,
                                   GimpHelperTool *text_tool)
{
